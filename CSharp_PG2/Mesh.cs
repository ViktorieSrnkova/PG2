...
namespace CSharp_PG2
{
    public class Mesh
    {
        ...
        public Mesh(Shader shader, Vertex[] vertices, uint[] indices, Texture? texture = null, int primitiveType = (int)PrimitiveType.Triangles)
        {
            _shader = shader;
            _vertices = vertices;
            _indices = indices;
            ...
            GL.VertexAttribPointer(2, 2, VertexAttribPointerType.Float, false, vertexSize, Marshal.OffsetOf<Vertex>("TexCoord"));
        ...
        private static Tuple<List<Vector3>, List<Vector2>, List<Vector3>> ReadObject(string path) {
